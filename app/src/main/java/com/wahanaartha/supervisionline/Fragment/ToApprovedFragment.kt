...
import com.wahanaartha.supervisionline.Activities.ListApprove2Activity
...
class ToApprovedFragment : Fragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        recycler_view_approve!!.addOnItemTouchListener(RecyclerItemClickListener(context, RecyclerItemClickListener.OnItemClickListener { view, position ->
            val intent = Intent(context, ListApprove2Activity::class.java)
    ...
    fun getData() {
        ...
        val id = savedUser.id
        API.getListApprove(id).enqueue(object : Callback<ArrayList<ListApprove>> {
